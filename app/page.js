...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between" style={bgGradient}>
      <div className="grid grid-cols-12 w-full h-full font-mono p-8 text-sm z-10">
        ...
        <div className="w-full h-full flex bg-slate-100/50 backdrop-blur-md col-span-5 rounded-3xl shadow-2xl items-center justify-center">
          <StartForm />
        </div>
      </div>
    </main>
